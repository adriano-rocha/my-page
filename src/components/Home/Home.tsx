    ...
    >
      <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
        ...
        <p className="text-gray-100 mb-8 max-w-md mx-auto lg:mx-0">
          <i>
            Crio soluções digitais completas, construindo sites e aplicações que
            combinam interfaces modernas com o poder do backend.
          </i>
        </p>
      ...
      <div className="flex-1 flex justify-center lg:justify-end order-1 lg:order-2">
        <div className="relative">
          ...
          {/* Ícone React - posição responsiva */}
